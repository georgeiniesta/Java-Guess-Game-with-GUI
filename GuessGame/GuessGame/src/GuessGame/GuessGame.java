...
public class GuessGame extends JFrame{
	...
	public void checkGuess() {
		...
		if (guess < theNumber)
			...
			message = guess + " is correct! You win!"  +" You needed " + tries +" tries";
	...
	public GuessGame() {
		...
		btnGuess.setBounds(138, 165, 159, 25);
		btnGuess.setFont(new Font("Tahoma", Font.BOLD, 14));
		btnGuess.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//adding GUI functionality to use checkGuess method
				checkGuess();
			}
		});
		...
		lblOutput.setBounds(10, 200, 414, 34);
		...
		playAgainBtn.setFont(new Font("Tahoma", Font.BOLD, 17));
		playAgainBtn.setBounds(129, 159, 168, 34);
